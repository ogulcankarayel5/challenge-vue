<template>
  <base-modal :id="itemId" :title="'Remove Link'" :name="'remove'">
    ...
    <template v-slot:footer>
      ...
      /></base-button>
      <base-button @onClick="closeModal(itemId + 'remove')" :variant="'primary'"
...
export default {
  ...
  methods: {
    ...
    removeItemFromList() {
      ...
      this.closeModal(this.itemId + 'remove');
    },
  },
};
</script>
